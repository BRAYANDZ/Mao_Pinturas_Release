<%-- 
    Document   : RegistrarPedidos
    Created on : 30/06/2022, 12:47:36 a. m.
    Author     : brayan.daza
--%>
...
<html>
    <head>
        ...
        <%
            ...
            String proveedorName = String.valueOf(request.getAttribute("proveedorName"));
    ...
    <body>
        ...
        <!-- Content here-->
          <div class="container-fluid"> 
            <form action="Controlador?menu=RegistrarPedido" style="margin-left: 20px; " name="formulario" method="POST">
                <div class="container-fluid parte01">     
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="${proveedor.getNombres()}" class="form-control" name="txtproveedor" >
                                </div>
                            </div>
                                    ...
                                    <div class="row justify-content-around" style="margin-right: 150px;">
                                        <span class="border border-0">
                                            ...
                                            <div class="col-12"> 
                                                ...
                                                <label class="se" name="cliente" >${proveedor.getIndicativo_Tel1()} ${prove.getTelefono1()}</label>
                                                <br>    
                                                <label class="se"  style="font-weight: bold;">Tipo de Telefono: </label>
                                                <label class="se"  name="cliente" >${proveedor.getTipo_Tel2()}</label>
                                                <br>    
                                                <label class="se" style="font-weight: bold;">Telefono 2: </label>
                                                <label class="se" name="cliente" >${proveedor.getIndicativo_Tel2()} ${prove.getTelefono2()}</label>
                                                <br>  
