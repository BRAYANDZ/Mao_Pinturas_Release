...
<html>
    <head>
        ...
        <%
            ...
            String pv="0";
             pv = String.valueOf(request.getAttribute("pv"));
             String tamlp = String.valueOf(request.getAttribute("tamlp"));
    ...
    <body>
        ...
        <div id="datosproveedor">
            ...
            <form action="Controlador?menu=RegistrarPedido&accion=AgregarProveedor" style="margin-left: 20px; " name="formulario1" method="POST" class="form-neon">
                <div class="container-fluid">


                    <legend><i class="fas fa-shipping-fast fa-fw"></i> &nbsp; Información de proveedor </legend><br>
                    <div class="row">
                        <div class="col-12 col-md-3">
                            <div class="form-group">
                                <label>Proveedor  </label>
                                <a href="Controlador?menu=Pedidos"> <i class="fas fa-shipping-fast fa-fw"></i>+</a>
                                <select class="form-control" id="nav"   name="txtProveedor" onchange="elegir_opcion(this);" required="">
                        ...
                        <div class="col-6 col-md-2">
                            <button type="submit" name="accion" value="AgregarProveedor"  class="btn btn-raised btn-dark btn-sm"><i class="fas fa fa-plus"></i> </button>     
                        </div>
                        <div class="col-12 col-md-3">
                                <div class="form-group">
                                    <label>Proveedor Seleccionado</label>

                                    <input type="text" value="${proveedor.getNombres()}"  readonly="" class="form-control" name="txtproveedor" >
                                </div>
                            </div>
                    </div>
        ...
        <div class="container-fluid"> 
            ...
            <form action="Controlador?menu=RegistrarPedido" style="margin-left: 5px; " class="form-neon" name="formulario" method="POST">
                <div class="container-fluid parte01">     
                    <div class="datospedido parte01" id="datospedido">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-3">
                                <div class="form-group">
                                    <label>Proveedor Seleccionado</label>
                                    <input type="hidden" value="${proveedor.getIdProveedores()}" class="form-control" name="txtidproveedor" >
                                    <input type="text" value="${proveedor.getNombres()}" readonly="" class="form-control" name="txtNombreProveedor" >
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row justify-content-around" style="margin-right: 150px;">
                                        <span class="border border-0">
                                            ...
                                            <label class="se" name="FechaActual">${FechaActual}</label> <br>
    ...
    <script type="text/javascript">
      ...
      document.getElementById('completo').style.display = 'contents';
           </script>
  <%}else if (pv.equals("0")) {%>
          <script type="text/javascript">
      document.getElementById('datosproveedor').style.display = 'contents';
