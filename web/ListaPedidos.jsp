...
<% }else if (res.equals("Cancelado")) {%>
    ...
    <script type="text/javascript">
      ...
      <p>Fecha Solicitud:    <strong>${pd.getFecha_Solicitud()}</strong> <br>
         Fecha Entrega:    <strong> ${pd.getFecha_Entrega()}</strong> <br>
         Cantidad Total Productos:    <strong>${pd.getCan_Total_Productos()}</strong> <br>
         Valor del Pedido:    <strong> ${pd.getValor_Pedido()}</strong> <br>
         Proveedor:   <strong> ${pd.getProveedor()}</strong> <br>
         Usuario que registro Pedido:   <strong> ${pd.getUsuario()}</strong> <br>
         Estado del Pedido: <strong> ${pd.getEstado()}</strong>   <br>
         Observaciones del Pedido: <strong> ${pd.getObservacion_Pedido()}</strong></p>  
      <br>
      `, icon: "info",
                position: "top"
            });
