                        ...
                        <div class="form-group">
                            <label >Proveedor</label>
                             <select class="form-control"   name="txtProveedor" onchange="elegir_opcion(this);" >
                                 ...
                                 <c:forEach var="prov" items="${Proveedors}">
                                    <c:choose>
                                        <c:when test="${prov.getIdProveedores()== Productos.getProveedor()}">
                                            <option value="${prov.getIdProveedores()}" selected=""> ${prov.getNombres()}</option>  
                                        </c:when> 
                                        <c:otherwise>
