<%-- 
    Document   : ListaProductosStockMinimo
    Created on : 22/06/2022, 12:55:37 a. m.
    Author     : brayan.daza
--%>
...
<html lang="es">
    ...
    <body>
        ...
        <div class="full-box page-header">
            <h3 class="text-left">
                <i class=" zmdi zmdi-dropbox fa-fw"></i> &nbsp; LISTA DE PRODUCTOS POR DEBAJO DEL STOCK MINIMO
            </h3>
            <p class="text-justify">

                En este modulo encontrara la lista de productos que tienen un Stock por debajo del minimo. </p>
        </div>

        <div class="container-fluid">
            <ul class="full-box list-unstyled page-nav-tabs">
                <li>
                    <a class="active"><i class="fas fa-clipboard-list fa-fw"></i> &nbsp; LISTADO DE PRODUCTOS CON STOCK MINIMO</a>
                </li>
                <li>
                    <a href="Controlador?menu=Proveedores&accion=ListarPedidos"><i class="fas fa-plus fa-fw"></i> &nbsp; AGREGAR NUEVO PEDIDO</a>
                </li>
            </ul>	
        </div>
        <div class="container-fluid">
                ...
                <table  class="table  table-sm  table table-bordered table stacktable" id="tablax">
                    ...
                    <thead style="background-color: white;">
                        <tr class="text-center roboto-medium">
                            <th scope="row" style="color: #000;;"><strong>PRODUCTOS CON STOCK MINIMO</strong></th>
                        </tr>
                    </thead>
                    <tbody>
                                            ...
                                            <div class="media-body product-media-body">
                                                ...
                                                <div class="container-fluid">
                                                    <div class="row">
                                                        ...
                                                        <a href="Controlador?menu=Productos&accion=Consultaridprod2&id=${produ.getIdProductos()}" class="btn btn-info"  data-trigger="hover" data-placement="top" data-content="Información detallada" >
    ...
    <h2>${product.getNombre()}</h2> 
      ...
      Tipo IVA: <strong> ${product.getTipo_IVA()}</strong> <br>
      Proveedor: <strong> ${product.getNombreProveedor()}</strong></p>  
      `,
                position: "top"
            });
        };
