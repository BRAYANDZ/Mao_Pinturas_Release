<%-- 
    Document   : ListaVentasPendientes
    Created on : 25/06/2022, 2:26:56 a. m.
    Author     : brayan.daza
--%>
...
<html lang="es">
    ...
    <body>
        ...
        <div class="full-box page-header">
            <h3 class="text-left">
                <i class="fas fa-clipboard-list fa-fw"></i> &nbsp;  LISTADO DE VENTAS PENDIENTES
            </h3>
            <p class="text-justify">
                En el módulo VENTAS PENDIENTES podrá observar las ventas registradas como pendientes, además podrá realizar búsquedas de pedidos. </p>
        </div>
                    ...
                    <tbody>
                        <c:forEach var="Ventas" items="${vts}">
                            <tr class="text-center" >
                                ...
                                <td><a href="Controlador?menu=Ventas&accion=ConsultaridVentasPendientes&id=${Ventas.getIdVentas()}" >
