                ...
                <div class="row">
                    <div class="col-12 col-md-2">
                        <div class="form-group">
                            ...
                            <input type="number"  pattern="^[1-9]\d*$" class="form-control" name="txtCantidad" minlength="1" id="txtCantidad" maxlength="40" required>
                        </div>
                    </div>   
                    <div class="col-12 col-md-2">
                        <div class="form-group">
                            <label for="txtNombre_Empresa">Tope Min</label>
                            <input type="number"   pattern="^[1-9]\d*$" class="form-control" name="txtTope_Min" minlength="1"   maxlength="40" required>
                        </div>
                    </div>
                    <div class="col-12 col-md-2">
                        <div class="form-group">
                            <label for="txtNombre_Empresa">Tope Max</label>
                            <input type="number"   pattern="^[1-9]\d*$" class="form-control" name="txtTope_Max" minlength="1"  maxlength="40" required>
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-md-2">
                        <div class="form-group">
                            ...
                            <input type="number"  pattern="^[1-9]\d*$"  class="form-control" name="txtPrecio_Compra" minlength="1"  maxlength="40" required>
                        </div>
                    </div>
                    <div class="col-12 col-md-2">
                        <div class="form-group">
                            <label for="txtDireccion_Empresa">Precio Venta</label>
                            <input type="number"   pattern="^[1-9]\d*$" class="form-control" name="txtPrecio_Venta" minlength="1"  maxlength="40" required>
                        </div>
                    </div>
