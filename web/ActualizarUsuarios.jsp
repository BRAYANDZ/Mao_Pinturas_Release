...
<html lang="es">
    <head>
        ...
        <%
            ...
            String use = String.valueOf(request.getParameter("us"));
        %>
    </head>
    <body>
        ...
        <div class="full-box page-header">
            ...
            <p class="text-justify">
                En el módulo ACTUALIZAR DATOS, el usuario podra actualizar su información en el sistema.	
            </p>
            <%}else{%>
          <p class="text-justify">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-6">
                              ...
                              <input  type="hidden" name="usu" value="2">
                               <%}else{%>
                               <input  type="hidden" name="usu" value="1">
                                  <%}%>
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                            ...
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                                    <label>Genero</label>
                                    <select class="form-control"  id="txtGenero" name="txtGenero" required onchange="elegir_opcion(this);" >
