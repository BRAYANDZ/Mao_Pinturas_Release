                            ...
                            <select class="form-control"  id="txtTipodocumento" name="txtTipoDocumento" onchange="elegir_opcion(this);" required>
                                ...
                                <c:choose>
                                            <c:when test="${clientes.getTipoDocumento()=='Cedula de Ciudadania'}">
                                                ...
                                                <option value="Documento de Identificación Extranjera">Documento de Identificación Extranjera</option>
                                            ...
                                            <c:when test="${clientes.getTipoDocumento()== 'Documento de Identificación Extranjera'}">
                                                <option value="Cedula de Ciudadania">Cédula de Ciudadania</option>
                                                <option value="Cedula de Extranjeria">Cédula de Extranjeria</option>
                                                <option value="Documento de Identificación Extranjera" selected="">Documento de Identificación Extranjera</option>
                                                <option value="Pasaporte">Pasaporte</option>
                                                <option value="Registro Civil">Registro Civil</option>
                                                <option value="Tarjeta de Identidad">Tarjeta de Identidad</option>
