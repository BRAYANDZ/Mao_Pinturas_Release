<%-- 
    Document   : ListaVentasEntregadas
    Created on : 25/06/2022, 2:29:26 a. m.
    Author     : brayan.daza
--%>
...
<html lang="es">
    ...
    <body>
        ...
        <div class="full-box page-header">
            <h3 class="text-left">
                <i class="fas fa-clipboard-list fa-fw"></i> &nbsp;  LISTADO DE VENTAS ENTREGADAS
            </h3>
            <p class="text-justify">
                En el módulo VENTAS ENTREGADAS podrá observar las ventas registradas como entregadas, además podrá realizar búsquedas de pedidos. </p>
        </div>

        <div class="container-fluid">
            <ul class="full-box list-unstyled page-nav-tabs">
                <li>
                    <a class="active" href="#"><i class="fas fa-clipboard-list fa-fw"></i> &nbsp; LISTA DE VENTAS PENDIENTES</a>
                </li>
                    ...
                    <tbody>
                        <c:forEach var="Ventas" items="${vts}">
                            <tr class="text-center" >
                                ...
                                <td><a href="Controlador?menu=Ventas&accion=ConsultaridVentasEntregadas&id=${Ventas.getIdVentas()}" >
