    ...
    <body>
        ...
        <div class="form-container">
            ...
            <form action="Validar" method="POST">
                ...
                <div style="text-align: center; "><button class="btn-group-lg" style="background-color: #fff; border:none; color: #545353; font-size: 17px" name="accion"  value="Ingresar" type="submit">Ingresar al sistema &nbsp; <i class="zmdi zmdi-arrow-right"></i></button><br>
                </div><br>
                <br>
              ...
              <form action="Controlador?menu=Ciudad" method="POST">
                  ...
                  <div><button value="ListarLogin"  class="btn-group-lg" name="accion" style="background-color: #fff; text-decoration: none; color:#545353;  border:none; font-size: 17px" type="submit"> <i class="zmdi zmdi-accounts-add"></i>&nbsp; Registrarme en el sistema </button></div>
             </form>
        </div>  
    </body>
</html>
