...
public class Productos {
    ...
    public Productos(int IdProductos, String Nombre, String Descripcion, String Marca, int Cantidad, int Tope_Min, int Tope_Max, String Codigo_Barras, double Precio_Compra, double Precio_Venta, String Fecha_Registrado, String Fecha_Vencimiento, String Estado, int Usuario_Registra, int Categoria_Productos, String Usuario, String Categoria, String Tipo_IVA, int IVA, int Proveedor) {
