...
public class ProductosDAO {
    ...
    public List listar() {
        ...
        String sql = " SELECT pro.*,provee.Nombres , emp.Nombre1, emp.Apellido1 ,cate.* FROM inventario_productos pro INNER JOIN categoria_productos cate ON cate.IdCategoriaProductos = pro.Categoria_Productos INNER JOIN empleado emp ON emp.IdEmpleado = pro.Usuario_Registra INNER JOIN proveedores provee ON provee.idProveedores = pro.Proveedores";
        ...
        try {
            ...
            while (rs.next()) {
                ...
                prod.setNombreProveedor(rs.getString("provee.Nombres"));
    ...
    public List listarStock() {
        ...
        String sql = " SELECT pro.*, emp.Nombre1, emp.Apellido1,provee.Nombres ,cate.* FROM inventario_productos pro INNER JOIN categoria_productos cate ON cate.IdCategoriaProductos = pro.Categoria_Productos INNER JOIN empleado emp ON emp.IdEmpleado = pro.Usuario_Registra INNER JOIN proveedores provee ON provee.idProveedores = pro.Proveedores  where pro.Tope_Min>=pro.Cantidad ";
    ...
    public int agregar(Productos pro) {
        String sql = "insert into inventario_productos (Nombre, Descripcion, Marca, Cantidad, Tope_Min, Tope_Max, Codigo_Barras, Precio_Compra, Precio_Venta, Fecha_Registrado, Fecha_Vencimiento, Estado, Usuario_Registra, Categoria_Productos,Proveedores)values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
        int res = 0;
        try {
    ...
    public Productos ListarId(int Id) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                prod.setProveedor(rs.getInt("Proveedores"));
    ...
    public Productos ListarIdTablas(int Id) {
        Productos prod = new Productos();
        String sql = "Select pro.*, emp.Nombre1,emp.Apellido1, cate.*, provee.Nombres from inventario_productos pro INNER JOIN empleado emp ON pro.Usuario_Registra=emp.IdEmpleado INNER JOIN categoria_productos cate ON pro.Categoria_Productos=cate.IdCategoriaProductos INNER JOIN proveedores provee ON provee.idProveedores = pro.Proveedores  where IdProductos=" + Id;
 ...
 public Productos ListarCodigo_Barras(String Codigo_Barras) {
        Productos prod = new Productos();
String sql = "Select pro.*, provee.Nombres, emp.Nombre1,emp.Apellido1, cate.* from inventario_productos pro INNER JOIN empleado emp ON pro.Usuario_Registra=emp.IdEmpleado INNER JOIN categoria_productos cate ON pro.Categoria_Productos=cate.IdCategoriaProductos INNER JOIN proveedores provee ON provee.idProveedores = pro.Proveedores  where Codigo_Barras=" + Codigo_Barras;
    ...
    public Productos ListarCodigo_Barras2(String Codigo_Barras, int provee) {
        Productos prod = new Productos();
        String sql = "Select pro.*, provee.Nombres, emp.Nombre1,emp.Apellido1, cate.* from inventario_productos pro INNER JOIN empleado emp ON pro.Usuario_Registra=emp.IdEmpleado INNER JOIN categoria_productos cate ON pro.Categoria_Productos=cate.IdCategoriaProductos INNER JOIN proveedores provee ON provee.idProveedores = pro.Proveedores  where pro.Codigo_Barras='"+Codigo_Barras+"' And pro.Proveedores="+provee;
    ...
    public int actualizar(Productos pro) {
        int r = 0;
        String sql = "update inventario_productos set Nombre=?, Descripcion=?, Marca=?, Cantidad=?, Tope_Min=?, Tope_Max=?, Codigo_Barras=?, Precio_Compra=?, Precio_Venta=?, Fecha_Vencimiento=?, Estado=?, Usuario_Registra=?, Categoria_Productos=?, Proveedores=? where IdProductos=?";
        ...
        try {
            ...
            ps.setInt(14, pro.getProveedor());
            ps.setInt(15, pro.getIdProductos());
