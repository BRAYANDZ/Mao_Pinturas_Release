...
public class ProveedoresDAO {
    ...
    public List listar() {
        ...
        String sql = " SELECT prove.*, ciu.Nombre FROM proveedores prove INNER JOIN ciudad ciu ON prove.Ciudad = ciu.idCiudad";
        ...
        try {
            ...
            while (rs.next()) {
                ...
                prov.setIdProveedores(rs.getInt("prove.idProveedores"));
                prov.setNombres(rs.getString("prove.Nombres"));
                prov.setIndicativo_Tel1(rs.getString("prove.Indicativo_Tel1"));
                prov.setTelefono1(rs.getString("prove.Telefono1"));
                prov.setTipo_Tel1(rs.getString("prove.Tipo_Tel1"));
                prov.setIndicativo_Tel2(rs.getString("prove.Indicativo_Tel2"));
                prov.setTelefono2(rs.getString("prove.Telefono2"));
                prov.setTipo_Tel2(rs.getString("prove.Tipo_Tel2"));
                prov.setDireccion(rs.getString("prove.Direccion"));
                prov.setEmail(rs.getString("prove.Email"));
                prov.setNombreCiudad(rs.getString("ciu.Nombre"));
                prov.setEstado(rs.getString("prove.Estado"));
