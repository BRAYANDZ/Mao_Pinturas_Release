        ...
        if (menu.equals("Pedidos")) {
            switch (accion) {
                ...
                case "VerPedido":
                    ...
                    Proveedores provedorpd = provDAO.ListarId(pd2.getProveedores());
                    Empleado em2 = edao.ListarId(pd2.getEmpleado());
                    String fechapd=pd2.getFecha_Solicitud();
                   
                    double subtdt = 0;
                    double totaldtIVA = 0;

                    for (int i = 0; i < listadt.size(); i++) {
                        subtdt = subtdt + listadt.get(i).getValor_Unitario()* listadt.get(i).getCantidad_Productos();
                        totaldtIVA = totaldtIVA + listadt.get(i).getValor_Productos() * listadt.get(i).getPorcentajeIVA() / 100;
                    }

                    request.setAttribute("fecha", fechapd);
                    request.setAttribute("proveedor", provedorpd);
                    request.setAttribute("empleado", em2);
        ...
        if (menu.equals("Ventas")) {
            switch (accion) {
                ...
                case "ListarVentasCanceladas":
                    ...
                    request.getRequestDispatcher("ListaVentasCanceladas.jsp").forward(request, response);
                    break;
                ...
                case "ConsultaridVentas":
                    ...
                    break;
                case "ConsultaridVentasPendientes":
                    String idstr3 = request.getParameter("id");
                    int id3 = Integer.parseInt(idstr3);
                    Ventas vt3 = ventasdao.ListarId(id3);
                    request.setAttribute("vt", vt3);
                    if (vt3.getFecha_Entrega() != null) {
                        request.getRequestDispatcher("Controlador?menu=Ventas&accion=ListarVentasPendientes&par=1").forward(request, response);
                    } else {
                        request.getRequestDispatcher("Controlador?menu=Ventas&accion=ListarVentasPendientes").forward(request, response);
                    }
                    break;
                case "ConsultaridVentasEntregadas":
                    String idstr4 = request.getParameter("id");
                    int id4 = Integer.parseInt(idstr4);
                    Ventas vt4 = ventasdao.ListarId(id4);
                    request.setAttribute("vt", vt4);
                    if (vt4.getFecha_Entrega() != null) {
                        request.getRequestDispatcher("Controlador?menu=Ventas&accion=ListarVentasEntregadas&par=1").forward(request, response);
                    } else {
                        request.getRequestDispatcher("Controlador?menu=Ventas&accion=ListarVentasEntregadas").forward(request, response);
                    }
                    break;
                case "ConsultaridVentasCanceladas":
                    String idstr5 = request.getParameter("id");
                    int id5 = Integer.parseInt(idstr5);
                    Ventas vt5 = ventasdao.ListarId(id5);
                    request.setAttribute("vt", vt5);
                    if (vt5.getFecha_Entrega() != null) {
                        request.getRequestDispatcher("Controlador?menu=Ventas&accion=ListarVentasCanceladas&par=1").forward(request, response);
                    } else {
                        request.getRequestDispatcher("Controlador?menu=Ventas&accion=VentasCanceladas").forward(request, response);
                    }
                    break;
        ...
        if (menu.equals("Proveedores")) {
            switch (accion) {
                ...
                case "ListarPedidos":
                    ...
                    if (proveedor.getIdProveedores()==0) {
                         request.setAttribute("proveedores", lista2);
                         String btn="0";
                         request.setAttribute("btn", btn);
                    }
                    
                    request.setAttribute("tamlp", tamlp);
        ...
        if (menu.equals("Categoria_Productos")) {
            switch (accion) {
                ...
                case "ListarenProductos":
                    ...
                    List listaproveedores = provDAO.listar();
        ...
        if (menu.equals("Productos")) {
            switch (accion) {
                ...
                case "Actualizar":
                    ...
                    int Proveedor1 = Integer.parseInt(request.getParameter("txtProveedor"));
                    ...
                    productos.setProveedor(Proveedor1);
                ...
                case "Editar":
                    ...
                    List listacategorias = cpDAO.listar();
                    List listaempleados = edao.listarempleados();
                    List listaproveedoress = provDAO.listar();
                    
                    if (listaproveedoress.isEmpty()) {
                        System.out.println("vacio");
                    } 
                    request.setAttribute("Productos", pro);
                    request.setAttribute("Proveedors", listaproveedoress);
                    request.setAttribute("Categoria", listacategorias);
                    request.setAttribute("Usuario_Registra", listaempleados);
        ...
        if (menu.equals("Proveedores")) {
            switch (accion) {
                case "Agregar":
                    ...
                    proveedor.setIndicativo_Tel1(Indicativo_Tel1);
                    proveedor.setTelefono1(Telefono1);
                    proveedor.setTipo_Tel1(Tipo_Tel1);
                    proveedor.setIndicativo_Tel2(Indicativo_Tel2);
                    proveedor.setTelefono2(Telefono2);
                    proveedor.setTipo_Tel2(Tipo_Tel2);
                    proveedor.setDireccion(Direccion);
                    proveedor.setEmail(Email);
                    proveedor.setCiudad(Ciudad);
                    proveedor.setEstado(Estado);
                    int res = provDAO.agregar(proveedor);
                    System.out.println(Nombres + Indicativo_Tel1 + Telefono1 + Tipo_Tel1 + Indicativo_Tel2 + Telefono2 + Tipo_Tel2 + Direccion + Email + Ciudad + Estado);
                ...
                case "Actualizar":
                    ...
                    proveedor.setNombres(Nombres1);
                    proveedor.setIndicativo_Tel1(Indicativo_Tel_1);
                    proveedor.setTelefono1(Telefono__1);
                    proveedor.setTipo_Tel1(Tipo_Tel_1);
                    proveedor.setIndicativo_Tel2(Indicativo_Tel_2);
                    proveedor.setTelefono2(Telefono_2);
                    proveedor.setTipo_Tel2(Tipo_Tel_2);
                    proveedor.setDireccion(Direccion1);
                    proveedor.setEmail(Email1);
                    proveedor.setCiudad(Ciudad1);
                    proveedor.setEstado(Estado1);
                    proveedor.setIdProveedores(idproveedor);

                    int resss = provDAO.actualizar(proveedor);
                ...
                case "Inhabilitar":
                    ...
                    proveedor.setEstado(estado2);
                    proveedor.setIdProveedores(id2);
                    r = provDAO.actualizarEstado(proveedor);
        ...
        if (menu.equals("RegistrarPedido")) {
            switch (accion) {
                case "AgregarProveedor":
                        String idprove = request.getParameter("txtProveedor");
                        System.out.println("haner " + idprove);
                        int id = Integer.parseInt(idprove);
                        proveedor = provDAO.ListarIdTablas(id);
                ...
                case "Buscar Producto":
                    productos = new Productos();
                    String codigoproducto = request.getParameter("txtCodigoProducto");
                    String idpro = request.getParameter("txtidproveedor");
                    int idpr = Integer.parseInt(idpro);
                    productos.setCodigo_Barras(codigoproducto);
                    productos = productosDAO.ListarCodigo_Barras2(codigoproducto, idpr);
                ...
                case "Cancelar":
                    ...
                    proveedor = new Proveedores();
                     request.setAttribute("proveedor", null);
                    request.setAttribute("respuesta", respu);
                    request.setAttribute("proveedores", lista2);
                    request.setAttribute("subtotal", subt2);
                    request.setAttribute("totalIVA", totalIVA2);
                ...
                case "GenerarPedido":
                    ...
                    int Proveedor = Integer.parseInt(request.getParameter("txtidproveedor"));
